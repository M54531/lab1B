...
public class Testttt {
    ...
    public void testLoadCar() {
        ...
        big.loadCar(v2);
        System.out.println(big.getCars1().get(0));
        assertEquals(big.getCars1().get(0), v2);
    }
    @Test
    public void testUnloadCar() {
        ...
        big.loadCar(v2);
        big.unload();
        assertEquals(big.getCars1().size(),0);
    }
    @Test
    public void testMax(){
        ...
        verk.loadCar(v1);
        verk.loadCar(s1);
        assertEquals(verk.carsInside.size(),1);
    }
    @Test
    public void unloadverkstad(){
        ...
        verk.loadCar(v1);
        verk.unloadCar(v1);
        assertEquals(verk.carsInside.size(),0);
    }
    @Test
