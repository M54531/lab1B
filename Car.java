...
public abstract class Car implements Movable{
    ...
    /**
     * Creates car
     * @param door number of doors to set
     * @param clr color to set
     * @param power cars engine power to set
     * @param name name to set for car
     */
    public void car(int door, Color clr, int power, double size,String name) {
        setNrDoors(door);
        setColor(clr);
